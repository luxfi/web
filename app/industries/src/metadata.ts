...
export default {
  metadataBase: new URL("https://luxindustries.xyz"),
  title: {
    default: "Lux Industries",
    template: "%s | Lux Industries",
  },
  description: "Pioneer the future of technology with Lux Industries",
  applicationName: "Lux Industries",
  authors: { name: "Lux Industries Inc" },
  keywords:
    "Lux, Lux Industries, Lux DeFi, Lux Network, DeFi, Web3, Privacy, Quantum Security, Blockchain, Bridge, Multi-Chain, Ethereum, EVM, Solana, Bitcoin, Cross-Chain, Interoperability, Cryptocurrency, Blockchain Technology",
  icons: [
    {
      rel: "icon",
      type: "image/png",
