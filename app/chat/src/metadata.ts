...
export default {
  ...
  description: 'Lux AI is a fully open-source AI-powered answer engine and interface to DeFi with a generative UI.',
  applicationName: 'Lux Chat',
  authors: {name: 'Lux Dev team'},
  keywords: "Lux Chat, Blockchain Bridge, Multi-Chain, EVM, Solana, Bitcoin, Cross-Chain, Interoperability, Cryptocurrency, Blockchain Technology",
  icons: [
    {
      rel: 'icon',
      type: 'image/png',
