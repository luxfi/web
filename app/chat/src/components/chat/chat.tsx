...
export function Chat({ id }: ChatProps) {
  ...
  return (
    <div ref={containerRef} className="min-h-[calc(100vh-80px)] mt-[80px] overflow-x-hidden px-8 sm:px-12 pt-12 md:pt-14 pb-14 md:pb-24 w-full mx-auto flex flex-col space-y-3 md:space-y-4">
