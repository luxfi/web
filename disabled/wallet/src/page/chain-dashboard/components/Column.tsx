...
import type { NodeStatus } from "@lux-wallet/lux-api/dist/types";
  ...
  return (
    <div className={style.columnHeader}>
      ...
      <div className={style.other}>
        <div>Lux RPC Status</div>

        <img
          data-tooltip-id={TOOLTIP_ID}
          data-tooltip-content="Lux's RPC endpoint deployed on this chain. Unstable status results
      ...
      <div className={style.other}>
        <div>Lux Data Service</div>

        <img
          data-tooltip-id={TOOLTIP_ID}
          data-tooltip-content="Lux's backend data service. Unstable status may cause delays in
    ...
    >
      ...
      <div className={style.other}>
        <NodeStatusInfo
          officialNodeHeight={official_node_height}
          officialNodeTimestamp={official_node_timestamp}
          targetNodeHeight={lux_node_height}
        />
      </div>
      <div className={style.other}>
        <NodeStatusInfo
          officialNodeHeight={official_node_height}
          officialNodeTimestamp={official_node_timestamp}
          targetNodeHeight={lux_data_service_height}
        />
      </div>
    </div>
  );
