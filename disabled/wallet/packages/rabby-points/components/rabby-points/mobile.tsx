...
const storeList: InstallItem[] = [
  {
    title: "Google Play",
    img: `${BASE_PATH}/assets/lux-points/play-store.png`,
    linkURL:
      "https://play.google.com/store/apps/details?id=com.debank.luxmobile",
  },
  {
    title: "Android APK",
    img: `${BASE_PATH}/assets/lux-points/android-apk.svg`,
    linkURL:
      "https://download.luxwallet.xyz/downloads/wallet-mobile/android/lux-mobile.apk",
  },
  {
    title: "App Store",
    img: `${BASE_PATH}/assets/lux-points/app-store.png`,
    linkURL: "https://apps.apple.com/us/app/lux-wallet-crypto-evm/id6474381673",
  },
];
  ...
  return (
    <>
      <div className={clsx(styles.subTitle, "mb-[18px]")}>
        1. Download Lux Wallet Mobile Beta
      </div>
      ...
      <div className={clsx(styles.subTitle)}>
        2. Connect your wallet and go to Lux Points
      </div>
      ...
      <div className="flex items-center">
        <img
          ...
          src={`${BASE_PATH}/assets/lux-points/points-example.png`}
          alt="lux-points"
        />
      </div>
    </>
