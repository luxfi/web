...
const RootLayout: React.FC<PropsWithChildren & {
  ...
  const Guts: React.FC = () => (<>
    ...
    {children}
    {chatbot && ( // TODO: questions could optionally be fed in from sideDef.ext.aiBot or some such thing.
      <ChatWidget title='LUX' subtitle='AI' chatbotUrl='https://lux.chat/iframe' />
    )}
  </>)
